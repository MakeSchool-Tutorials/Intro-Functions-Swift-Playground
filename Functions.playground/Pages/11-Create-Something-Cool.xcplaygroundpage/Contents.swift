...
/*:
 - note: （メモ）初めはペンを置いた状態からスタートしています。
...
/*:
 - note: （メモ）それぞれの値は0から1の間で設定します。`setColor(red: 0.0, green: 0.0, blue: 0.0)`は黒色に、 `setColor(red: 1.0, green: 0.0, blue: 0.0)`は赤色になります。
 */
...
/*:
 ...
 - callout(チャレンジ):ここにコードを書いていきましょう！
